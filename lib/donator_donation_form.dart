...
import 'donator_donation_location.dart';
void main()
{
  runApp(MaterialApp(
    debugShowCheckedModeBanner: false,
    home: donator_donation_form(),
  )
  );
}

class donator_donation_form extends StatefulWidget {
  @override
  _user_donation_formState createState() => _user_donation_formState();
}

class _user_donation_formState extends State<donator_donation_form> {
