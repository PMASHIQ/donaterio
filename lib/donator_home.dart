import 'package:donaterio/donator_donation_form.dart';
...
class _MyAppState extends State<DonatorHome> {
  @override
...
class _HomeState extends State<DHome> {
        ...
        actions: <Widget>[
          FlatButton(
            onPressed: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => donator_donation_form()),
              );
      ...
      drawer: Drawer(
        child:ListView(
          children: <Widget>[
            ...
            CustomList(Icons.transfer_within_a_station,'Donated',()=>{
              Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context)=>DonatedDetail())),
            }),
